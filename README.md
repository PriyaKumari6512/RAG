...
The project was conducted at **Robert Bosch Engineering and Business Solutions (BGSW), Bengaluru** as an applied AI research initiative. It compares two fundamentally different RAG paradigms:
...
Both systems are evaluated against a purpose-built gold-standard benchmark of **1,000+ validated AUTOSAR question-answer pairs**, built from scratch using a custom RAGAS-based pipeline with LLM-as-judge quality validation.
...
│   ├── run_rag_vbest.py         # Recommended evaluation runner
...
# 2. Run a query
python VectorLess_DB/run_rag_vbest.py \
    --mode infer \
...
**Praveen Solanki (OLJ3KOR)** — M.Tech CSE, IIT Mandi  
**Priya Kumari (MPQ3KOR)**  

Project Guide: Ganesh Jayabal | Ishan Dindorkar  
